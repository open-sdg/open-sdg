...
const driver = new mink.Mink({
  ...
  selectors: {
    ...
    "the first filter drop-down button": ".variable-selector:nth-of-type(1) accessBtn",
    "the second filter drop-down button": ".variable-selector:nth-of-type(2) accessBtn",
    "the third filter drop-down button": ".variable-selector:nth-of-type(3) accessBtn",
    "the fourth filter drop-down button": ".variable-selector:nth-of-type(4) accessBtn",
    ...
    "the first filter option in the first filter drop-down": ".variable-selector:nth-of-type(1) .variable-options label",
    "the first filter option in the second filter drop-down": ".variable-selector:nth-of-type(2) .variable-options label",
    "the first filter option in the third filter drop-down": ".variable-selector:nth-of-type(3) .variable-options label",
    "the first filter option in the fourth filter drop-down": ".variable-selector:nth-of-type(4) .variable-options label",
