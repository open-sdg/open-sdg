...
const driver = new mink.Mink({
  ...
  selectors: {
    ...
    "the language toggle dropdown": "#menu .language-toggle-dropdown .dropdown-toggle",
    "the first language option": "#menu .language-toggle-dropdown .dropdown-menu li:first-child a",
    "the last language option": "#menu .language-toggle-dropdown .dropdown-menu li:last-child a",
