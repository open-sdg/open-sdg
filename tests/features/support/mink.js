...
const driver = new mink.Mink({
  ...
  selectors: {
    ...
    "the high-contrast button": ".contrast-high a",
    "goal icon": ".goal-tiles a img",
    "high-contrast goal icon": ".goal-tiles a img[src*='high-contrast']",
    "the language toggle dropdown": ".dropdown-toggle",
    "the first language option": ".dropdown-menu li:first-child a",
    "the last language option": ".dropdown-menu li:last-child a",
