Feature: Headlines
  ...
  Mixed-disaggregation indicator: An indicator that contains both a single-
  disaggregation series and a double-disaggregation series.
  ...
  condition. The datasets can be viewed are the following address:
